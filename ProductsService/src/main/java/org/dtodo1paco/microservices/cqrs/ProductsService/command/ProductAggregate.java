...
public class ProductAggregate {
	...
	public ProductAggregate(CreateProductCommand createProductCommand) {
		log.info("Creating ProductAggregate based on CreateProductCommand {}",createProductCommand);
		...
		log.info("Applying ProductCreatedEvent {}",productCreatedEvent);
		/*
		...
		*/
		AggregateLifecycle.apply(productCreatedEvent); // will dispatch the @EventSourcingHandler on(ProductCreatedEvent ev)

		/*
		throw new Exception("something BEFORE the message has been sent");
		* Any exception thrown here will be catched by the ControllerAdviser
		* */
	}
	//Initialize the current state of the aggregate based on the latest information
	@EventSourcingHandler
	public void on(ProductCreatedEvent productCreatedEvent) {
		log.info("ProductAggregate: Handling ProductCreatedEvent: {}",productCreatedEvent);
